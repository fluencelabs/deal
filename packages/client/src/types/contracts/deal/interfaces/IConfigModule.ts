...
export interface IConfigModuleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "appCID"
      | "effectors"
...
export interface IConfigModule extends BaseContract {
  connect(runner?: ContractRunner | null): IConfigModule;
  waitForDeployment(): Promise<this>;

  interface: IConfigModuleInterface;
