...
export interface StatusModuleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "changeStatus"
      | "proxiableUUID"
...
export interface StatusModule extends BaseContract {
  connect(runner?: ContractRunner | null): StatusModule;
  waitForDeployment(): Promise<this>;

  interface: StatusModuleInterface;
