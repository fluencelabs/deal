...
export interface PaymentModuleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balance"
      | "commitParticle"
...
export interface PaymentModule extends BaseContract {
  connect(runner?: ContractRunner | null): PaymentModule;
