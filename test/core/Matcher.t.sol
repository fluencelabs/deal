...
//                 peerIds[i][j] = peerId;
//                 peers[j] =
//                     IMarket.RegisterComputePeer({peerId: peerId, freeUnits: unitCountPerPeer, owner: address(this)});
...
//             deployment.core.registerMarketOffer(minPricePerWorkerEpoch, paymentToken, effectors, peers);
//         }
//     }
