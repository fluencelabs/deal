...
export type CapacityCommitmentStatsPerEpoch = {
  ...
  accumulatedAwards: Scalars["BigInt"]["output"];
  activeUnitCount: Scalars["Int"]["output"];
...
export type CapacityCommitmentStatsPerEpoch_Filter = {
  ...
  accumulatedAwards?: InputMaybe<Scalars["BigInt"]["input"]>;
  accumulatedAwards_gt?: InputMaybe<Scalars["BigInt"]["input"]>;
  accumulatedAwards_gte?: InputMaybe<Scalars["BigInt"]["input"]>;
  accumulatedAwards_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
  accumulatedAwards_lt?: InputMaybe<Scalars["BigInt"]["input"]>;
  accumulatedAwards_lte?: InputMaybe<Scalars["BigInt"]["input"]>;
  accumulatedAwards_not?: InputMaybe<Scalars["BigInt"]["input"]>;
  accumulatedAwards_not_in?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
