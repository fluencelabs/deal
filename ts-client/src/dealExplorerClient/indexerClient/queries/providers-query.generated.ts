...
export type ProvidersQueryQuery = {
  ...
  graphNetworks: Array<{ __typename?: "GraphNetwork"; providersTotal: any }>;
};

export type ProviderOfProvidersQueryFragment = {
  __typename?: "Provider";
  id: string;
  name: string;
  createdAt: any;
...
export type ProviderQueryQuery = {
  __typename?: "Query";
  provider?: {
    __typename?: "Provider";
    peerCount: number;
...
export type ProviderAbcFragment = {
  __typename?: "Provider";
  id: string;
  name: string;
  createdAt: any;
...
export function getSdk(
  ...
  return {
    ProvidersQuery(
      variables?: ProvidersQueryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<ProvidersQueryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProvidersQueryQuery>(
    ...
    ProviderQuery(
      variables: ProviderQueryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<ProviderQueryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ProviderQueryQuery>(ProviderQueryDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "ProviderQuery",
