...
export function getSdk(
  ...
  return {
    ConstantsQuery(
      variables?: ConstantsQueryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<ConstantsQueryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<ConstantsQueryQuery>(
            ConstantsQueryDocument,
            variables,
