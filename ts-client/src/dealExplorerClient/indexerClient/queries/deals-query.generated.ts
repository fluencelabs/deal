...
export type DealsQueryQuery = {
  ...
  deals: Array<{
    ...
    owner: string;
    registeredWorkersCurrentCount: number;
    matchedWorkersCurrentCount: number;
  ...
  graphNetworks: Array<{ __typename?: "GraphNetwork"; dealsTotal: any }>;
};
...
export type DealsByPeerQueryQuery = {
  __typename?: "Query";
  peer?: {
    __typename?: "Peer";
    id: string;
...
export function getSdk(
  ...
  return {
    ...
    DealsByPeerQuery(
      variables: DealsByPeerQueryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<DealsByPeerQueryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<DealsByPeerQueryQuery>(
            DealsByPeerQueryDocument,
            variables,
