...
export type OffersQueryQuery = {
  ...
  offers: Array<{
    ...
    computeUnitsAvailable?: number | null;
    paymentToken: {
      __typename?: "Token";
      id: string;
      symbol: string;
  ...
  graphNetworks: Array<{ __typename?: "GraphNetwork"; offersTotal: any }>;
};
...
export type EffectorQueryQuery = {
  __typename?: "Query";
  effectors: Array<{
    __typename?: "Effector";
    id: string;
  ...
  graphNetworks: Array<{ __typename?: "GraphNetwork"; effectorsTotal: any }>;
};
...
export type TokenQueryQuery = {
  ...
  graphNetworks: Array<{ __typename?: "GraphNetwork"; tokensTotal: any }>;
};
...
export function getSdk(
  ...
  return {
    ...
    EffectorQuery(
      variables?: EffectorQueryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<EffectorQueryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<EffectorQueryQuery>(EffectorQueryDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "EffectorQuery",
    ...
    TokenQuery(
      variables?: TokenQueryQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<TokenQueryQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<TokenQueryQuery>(TokenQueryDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "TokenQuery",
