...
export interface GenABIInterface extends Interface {
...
export interface GenABI extends BaseContract {
  connect(runner?: ContractRunner | null): GenABI;
  waitForDeployment(): Promise<this>;

  interface: GenABIInterface;
