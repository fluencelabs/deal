...
export interface MatcherConfigInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_globalCore"
      | "addEffector"
...
export interface MatcherConfig extends BaseContract {
  connect(runner?: ContractRunner | null): MatcherConfig;
