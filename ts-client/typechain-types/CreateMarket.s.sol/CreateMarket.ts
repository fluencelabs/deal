...
export interface CreateMarketInterface extends Interface {
...
export interface CreateMarket extends BaseContract {
  contractName: "CreateMarket";

  connect(runner?: ContractRunner | null): CreateMarket;
  waitForDeployment(): Promise<this>;

  interface: CreateMarketInterface;
