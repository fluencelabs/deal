...
export interface ConfigContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(
    functionFragment: "test_InitContract",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_SetAppCID",
    values?: undefined
  ): string;
...
export interface ConfigContract extends BaseContract {
  connect(runner?: ContractRunner | null): ConfigContract;
  waitForDeployment(): Promise<this>;

  interface: ConfigContractInterface;
  ...
  test_InitContract: TypedContractMethod<[], [void], "nonpayable">;

  test_SetAppCID: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_InitContract"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_SetAppCID"
  ): TypedContractMethod<[], [void], "nonpayable">;
