...
export interface MatcherTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  decodeFunctionResult(functionFragment: "test_Match", data: BytesLike): Result;
}
...
export interface MatcherTest extends BaseContract {
  contractName: "MatcherTest";

  connect(runner?: ContractRunner | null): MatcherTest;
  waitForDeployment(): Promise<this>;

  interface: MatcherTestInterface;
  ...
  test_Match: TypedContractMethod<[], [void], "nonpayable">;
