...
export interface MarketTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test_GetOfferPeersUnits"
      | "test_RegisterMarketOffer"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_GetOfferPeersUnits",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_RegisterMarketOffer",
    values?: undefined
  ): string;
...
export interface MarketTest extends BaseContract {
  contractName: "MarketTest";

  connect(runner?: ContractRunner | null): MarketTest;
  ...
  test_GetOfferPeersUnits: TypedContractMethod<[], [void], "nonpayable">;

  test_RegisterMarketOffer: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_GetOfferPeersUnits"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_RegisterMarketOffer"
  ): TypedContractMethod<[], [void], "nonpayable">;
