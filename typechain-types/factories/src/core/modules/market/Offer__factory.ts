...
import type {
  Offer,
  OfferInterface,
} from "../../../../../src/core/modules/market/Offer";
...
export class Offer__factory {
  static readonly abi = _abi;
  static createInterface(): OfferInterface {
    return new Interface(_abi) as OfferInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Offer {
    return new Contract(address, _abi, runner) as unknown as Offer;
  }
}
