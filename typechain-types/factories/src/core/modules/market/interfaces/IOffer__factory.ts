...
import type {
  IOffer,
  IOfferInterface,
} from "../../../../../../src/core/modules/market/interfaces/IOffer";
...
export class IOffer__factory {
  static readonly abi = _abi;
  static createInterface(): IOfferInterface {
    return new Interface(_abi) as IOfferInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IOffer {
    return new Contract(address, _abi, runner) as unknown as IOffer;
  }
}
