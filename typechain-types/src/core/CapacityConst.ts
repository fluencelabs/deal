...
export interface CapacityConstInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activeUnitCount"
      | "calculateRewardPool"
...
export interface CapacityConst extends BaseContract {
  connect(runner?: ContractRunner | null): CapacityConst;
  waitForDeployment(): Promise<this>;

  interface: CapacityConstInterface;
