...
export interface ICoreInitializableInterface extends utils.Interface {
  functions: {
...
export interface ICoreInitializable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICoreInitializableInterface;
