...
import type { IConfig, IConfigInterface } from "../../../../contracts/deal/interfaces/IConfig";
export declare class IConfig__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IConfig;
}
