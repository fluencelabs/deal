...
import type { MatcherOwnable, MatcherOwnableInterface } from "../../../../contracts/global/Matcher.sol/MatcherOwnable";
export declare class MatcherOwnable__factory {
    ...
    static createInterface(): MatcherOwnableInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): MatcherOwnable;
}
