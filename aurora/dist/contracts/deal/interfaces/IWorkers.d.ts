...
export interface IWorkersInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "createPAT" | "getNextWorkerIndex" | "getPATIndex" | "getPATOwner" | "getUnlockedAmountBy" | "removePAT" | "withdraw" | "workersCount"): FunctionFragment;
