...
describe("ProviderManager", () => {
    ...
    it("createProviderToken", async () => {
        ...
        const tx = await deal.createProviderToken(hardhat_1.ethers.utils.keccak256(hardhat_1.ethers.utils.toUtf8Bytes("salt")));
    ...
    it("getRewards", async () => {
        ...
        (0, chai_1.expect)(await deal.getPaymentBalance()).to.be.equal(balance.sub(price.mul(2)));
    });
